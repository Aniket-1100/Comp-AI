        ...
        <Card className="w-full max-w-md p-8 shadow-xl border-border bg-card/90 backdrop-blur-md">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
              ...
              <Button type="submit" className="w-full" variant="electric">Register</Button>
            </form>
            <Button variant="link" className="mt-6 w-full text-primary underline-offset-4 hover:underline" onClick={() => navigate('/login')}>Back to Login</Button>
          </CardContent>
        </Card>
      </motion.div>
    </div>
